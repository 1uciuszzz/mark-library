      ...
      <div className='container'>
        ...
        <div className='nes-container is-centered'>
          <div className='row justify-content-around'>
            <h2 className='col-4 nes-btn is-disabled'>leeh</h2>
            <h2 className='col-4 nes-btn is-disabled'>lsy</h2>
          </div>
          <div className='row'>
            <center>
              <h2 className='nes-btn is-disabled col-4'>
                [1uciuszzz](https://github.com/1uciuszzz)
              </h2>
            </center>
          </div>
          <div className='row justify-content-around'>
            <h2 className='col-4 nes-btn is-disabled'>mm</h2>
            <h2 className='col-4 nes-btn is-disabled'>lxl</h2>
          </div>
        </div>
      </div>
    </div>
